            ...
            <div style="background-color: #ffffff4D;z-index: 1;border-radius: 30px;">
              <el-row
                ...
                <el-row class="tablebody" v-for="value in info" :key="value.cno">
                  ...
                  <el-col :span="6">
                    <div style="width: 30%;margin: 0 auto;z-index: 100">
                      <el-button type="mini" @click="delinfo(value.cno)">退课</el-button>
                    </div>
                  </el-col>
                </el-row>
              </el-row>
...
export default {
  ...
  methods: {
    get_info() {
      ...
      this.$route.query.Sno = 201215122
    ...
    delinfo(cno) {
      this.$route.query.Sno = 201215122
      this.$http.delete('/api/student_course_springMVC_war_exploded/sc/del_Sc/' + this.$route.query.Sno + "/" + cno)
        .then(res => {
          this.get_info()
          // this.info = res.data
          // console.log(this.info)
