                ...
                <el-row style="height: 70%;border-radius: 30px;margin-top: 10%">
                  <el-form :model="g_info">
                    <el-row style="height: 20%;">
                      <el-col span="6">
                        <el-form-item label="课程名:"></el-form-item>
                      </el-col>
                      <el-col span="13">
                    ...
                    <el-row style="height: 20%;">
                      <el-col span="6">
                        <el-form-item label="先行课:"></el-form-item>
                      </el-col>
                      <el-col span="13">
                    ...
                    <el-row style="height: 20%;">
                      <el-col span="6">
                        <el-form-item label="学分:"></el-form-item>
                      </el-col>
                      <el-col span="13">
                    ...
                    <el-row style="height: 10%">
                      ...
                      <el-col span="4">
                        <div style="width: 80%;margin: 0 auto;">
                          <el-button type="primary" @click="upgradeinfo">修改</el-button>
                        </div>
                        <el-col span="8">
                        </el-col>
                      </el-col>
...
export default {
  ...
  beforeCreate() {
    ...
    this.$http.post('/api/student_course_springMVC_war_exploded/course/id_UpdateCourse/' + this.$route.query.Cno)
      .then(res => {
  ...
  methods: {
    upgradeinfo() {
      console.log(this.$route.query.Cno)
      this.$http.put('/api/student_course_springMVC_war_exploded/course/updateCourse/' + this.$route.query.Cno, this.g_info)
        .then(res => {
          this.backpage()
