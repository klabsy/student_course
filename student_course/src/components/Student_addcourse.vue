      ...
      <el-col :span="18">
        <el-row class="bodystyle">
            ...
            <div class="zuoce">
              <el-row class="zuocehead">
                <div>
                  ...
                  <el-row class="userinfo">学生</el-row>
                  <el-row class="userinfo">201215122</el-row>
                </div>
              </el-row>
              <el-row style="height: 15%">
                <div>
                  <router-link to="/student" class="alink">
                    首页
                  </router-link>
                </div>
              </el-row>
              <el-row style="height: 15%">
                <div>
                  <router-link to="/Student_grade" class="alink">
                    成绩
                  </router-link>
                </div>
              </el-row>
              <el-row style="height: 15%">
                <div>
                  <router-link to="/Student_course" class="alink">
                    科目
                  </router-link>
                </div>
              </el-row>
              <el-row style="height: 15%">
                <div>
                  <router-link to="/student_addcourse" class="alink">
                    选课
                  </router-link>
                </div>
              </el-row>
          ...
          <el-col :span="16" class="youce">
            <div style="background-color: #ffffff4D;z-index: 1;border-radius: 30px;">
              <el-row
                ...
                <el-row style="height: 70%;border-radius: 30px;margin-top: 10%">
                  <el-form :model="a_info">
                    <el-row style="height: 10%;margin-bottom: 20px">
                      <el-col span="6">
                        <el-form-item label="选课:"></el-form-item>
                      </el-col>
                      <el-col span="13">
                        <select v-model="a_info.cno" placeholder="请选择" >
                          <option v-for="item in options" :key="item.cno">{{ item.cname }}</option>
                        </select>
                      </el-col>
                      <el-col span="4">
                      </el-col>
