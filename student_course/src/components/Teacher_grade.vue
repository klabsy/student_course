            ...
            <div style="background-color: #ffffff4D;z-index: 100;border-radius: 30px;">
              <el-row
                ...
                <el-row class="tabletitle">
                  <el-col :span="6" :offset="8" style="padding-top: 10px;font-size: 20px">
                    选择科目:
                  </el-col>
                  <el-col :span="6">
                    <select v-model="this.cno" placeholder="请选择" >
                ...
                <el-row class="tablebody" v-for="value in info" :key="value.sno">
                  <el-col :span="3">
                    {{ value.sno }}
                  </el-col>
                  <el-col :span="4">
                  ...
                  <el-col :span="3">
                    ...
                    <div style="width: 90%;margin: 0 auto;">
                      <el-button type="mini">修改</el-button>
                    </div>
                  </el-col>
                  <el-col :span="3">
                    <div style="width: 90%;margin: 0 auto;">
                      <el-button type="mini" @click="delinfo(value.cno,value.sno)">删除</el-button>
                    </div>
                  </el-col>
                </el-row>
...
export default {
  ...
  mounted() {
    ...
    this.$http.post('/api/student_course_springMVC_war_exploded/sc/Cno_UpdateSc/' + this.cno)
      .then(res => {
        this.info = res.data
  ...
  methods: {
    delinfo(cno, sno) {
      console.log(cno, sno)
      this.$http.delete('/api/student_course_springMVC_war_exploded/sc/del_Sc/'+ sno +"/"+ cno)
        .then(res => {
          this.get_info()
          // this.info = res.data
          // console.log(this.info)
